    ...
    <script type="text/javascript">
        ...
        function doDelete(sid) {
            ...
            if(flag){
                ...
                location.href="StudentDeleteServlet?deleteId="+sid;
            }
        }
    </script>
    ...
    <table border="1" width="700">
        ...
        <c:forEach items="${pageBean.list }" var="stu">
            <tr align="center">
                ...
                <td>${stu.email }</td>
                <td>${stu.remark }</td>
                <td><a href="StudentEditServlet?sid=${stu.id }">更新</a>   <a href="#" onclick="doDelete(${stu.id})">删除</a></td>
            </tr>
        </c:forEach>
